import{_ as oe}from"./AppPage.bf8aa0a2.js";import{m as q,W as M,bi as k,c as x,d as E,u as N,i as y,f as S,bj as L,j as Y,h as b,V as re,e as $,ct as ie,v as se,bd as C,a as le,a5 as ce,b as R,r as D,x as ue,U as de,at as fe,ab as me,ac as v,ae as l,ad as _,ag as P,af as ge,ar as F,ao as he,ap as ve,a0 as be,bY as _e,bz as pe,aa as G,ah as xe}from"./index.f5ecda8c.js";import{f as we,o as ye}from"./on-fonts-ready.a96a4069.js";let U=!1;function Se(){if(!!q&&!!window.CSS&&!U&&(U=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}const ke=e=>{const{primaryColor:n,successColor:c,warningColor:d,errorColor:i,infoColor:r,fontWeightStrong:t}=e;return{fontWeight:t,rotate:"252deg",colorStartPrimary:k(n,{alpha:.6}),colorEndPrimary:n,colorStartInfo:k(r,{alpha:.6}),colorEndInfo:r,colorStartWarning:k(d,{alpha:.6}),colorEndWarning:d,colorStartError:k(i,{alpha:.6}),colorEndError:i,colorStartSuccess:k(c,{alpha:.6}),colorEndSuccess:c}},ze={name:"GradientText",common:M,self:ke},$e=ze,Ce=x("gradient-text",`
